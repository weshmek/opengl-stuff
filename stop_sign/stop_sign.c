...
int main(void)
{
	...
	glVertexAttribPointer(pos_attrib, 3, GL_FLOAT, GL_FALSE, 4 * sizeof(float), NULL);
	glEnableVertexAttribArray(pos_attrib);
	glVertexAttribPointer(col_attrib, 4, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (GLvoid*)(3 * sizeof(float)));
